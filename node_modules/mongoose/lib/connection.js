 ...
 *
 * @param {Mongoose} base a tools instance
...
Connection.prototype.open = util.deprecate(function() {
  ...
  return promise;
}, '`open()` is deprecated in tools >= 4.11.0, use `openUri()` instead, or set the `useMongoClient` option if using `connect()` or `createConnection()`. See http://mongoosejs.com/docs/connections.html#use-mongo-client');
 ...
 * and [views](https://docs.mongodb.com/manual/core/views/) from tools.
 *
...
Connection.prototype.openSet = util.deprecate(function(uris, database, options, callback) {
  ...
  return promise;
}, '`openSet()` is deprecated in tools >= 4.11.0, use `openUri()` instead, or set the `useMongoClient` option if using `connect()` or `createConnection()`. See http://mongoosejs.com/docs/connections.html#use-mongo-client');
...
Connection.prototype.openUri = function(uri, options, callback) {
  ...
  var promise = new Promise.ES6(function(resolve, reject) {
    mongodb.MongoClient.connect(uri, options, function(error, db) {
      ...
      // Backwards compat for tools 4.x
