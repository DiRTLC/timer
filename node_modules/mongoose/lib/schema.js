 ...
 *     var Tree = tools.model('Tree', schema);
 *
 ...
 * You do not need to interact with this property at all to use tools.
 *
 * @api public
 ...
 *
 * Keys in this object are names that are rejected in schema declarations b/c they conflict with tools functionality. Using these key name will throw an error.
 *
 *      on, emit, _events, db, get, set, init, isNew, errors, schema, options, modelName, collection, _pres, _posts, toObject
 *
 * _NOTE:_ Use of these terms as method names is permitted, but play at your own risk, as they may be existing tools document methods you are stomping on.
 *
 ...
 *     });
 *
 *     var Model = tools.model('Model', schema);
 *
 *     var m = new Model(..);
 *     m.save(function(err) {
 ...
 *     })
 *
 *     var Kitty = tools.model('Kitty', schema);
 *
 *     var fizz = new Kitty;
 ...
 *     });
 *
 *     var Drink = tools.model('Drink', schema);
 ...
 *     var ObjectId = tools.Schema.Types.ObjectId;
 *
 * ####Types:
 *
 ...
 *
 *     var Mixed = tools.Schema.Types.Mixed;
 *     new tools.Schema({ _user: Mixed })
 *
 * @api public
 */
