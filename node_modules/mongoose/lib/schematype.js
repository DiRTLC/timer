 ...
 *
 * Suppose you are storing credit card numbers and you want to hide everything except the last 4 digits to the tools user. You can do so by defining a getter in the following way:
 *
 ...
 *
 * Passing a validator function that receives two arguments tells tools that the validator is an asynchronous validator. The first argument passed to the validator function is the value being validated. The second argument is a callback function that must called when you finish validating the value and passed either `true` or `false` to communicate either success or failure respectively.
 *
 ...
 * the value is not null nor undefined). However, most built-in tools schema
...
var legacyAsyncValidate = require('util').deprecate(asyncValidate,
  ...
  'arguments) are deprecated in tools >= 4.9.0. See ' +
