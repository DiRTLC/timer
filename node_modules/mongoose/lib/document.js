 ...
 * ####Example
 *
 *     MyModel = tools.model('test', { name: { type: String, default: 'Val '} });
 *     var m = new MyModel();
 ...
 *     })
 *
 * @param {Boolean} [val] optional, overrides whether tools thinks the doc is deleted
 * @return {Boolean} whether tools thinks this doc is deleted.
 * @api public
 */
 ...
 *
 * - `doc` The tools document which is being converted
